# Real-Time Object Detection using Tensorflow Object_detection API
...
'!' These are shell commands. These are to be run in our Anaconda Prompt with the "Tensorflow"
folder as our command line location. You can change the location of command line by using 
"cd Documents\Tensorflow" in the Anaconda prompt as shown here:
...
def run_inference_for_single_image(model, image):
    ...
    # The number array is converted to a tensor object for tensorflow to work, this tensor object is our input to the model.
    # and is saved in 'input_tensor'
